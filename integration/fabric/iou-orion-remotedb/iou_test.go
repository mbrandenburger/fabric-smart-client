...
import (
	...
	iou_orion_remotedb "github.com/hyperledger-labs/fabric-smart-client/integration/fabric/iou-orion-remotedb"
...
var _ = Describe("EndToEnd", func() {
	...
	Describe("IOU Life Cycle", func() {
		BeforeEach(func() {
			...
			ii, err = integration.GenerateAt(StartPort(), "", true, iou_orion_remotedb.Topology()...)
